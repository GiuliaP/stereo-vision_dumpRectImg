...
public:
    ...
    */
    StereoCamera(bool rectify=true, double _io_scaling_factor = 1.0, bool _use_elas=false)
	{
    ...
    */
    StereoCamera(yarp::os::ResourceFinder &rf,bool rectify=true, double _io_scaling_factor = 1.0, bool use_elas=false);
    ...
    */
    StereoCamera(Camera First, Camera Second,bool rectify=true, double _io_scaling_factor = 1.0, bool use_elas=false);
